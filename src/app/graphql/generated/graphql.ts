...
export type AddUserMutation = ({ __typename?: 'Mutation' } & { addUser: Maybe<({ __typename?: 'User' } & Pick<User, 'id' | 'name' | 'picture_url'>)> });
...
export type AddMessageMutation = ({ __typename?: 'Mutation' } & { addMessage: Maybe<({ __typename?: 'Message' } & Pick<Message, 'content' | 'timestamp'>)> });

export type MessagesQueryVariables = {};


export type MessagesQuery = ({ __typename?: 'Query' } & { messages: Maybe<Array<Maybe<({ __typename?: 'Message' } & Pick<Message, 'content' | 'timestamp'> & { user: Maybe<({ __typename?: 'User' } & Pick<User, 'id' | 'name' | 'picture_url'>)> })>>> });

export type MessageAddedSubscriptionVariables = {};


export type MessageAddedSubscription = ({ __typename?: 'Subscription' } & { messageAdded: Maybe<({ __typename?: 'Message' } & Pick<Message, 'id' | 'content' | 'timestamp'> & { user: Maybe<({ __typename?: 'User' } & Pick<User, 'id' | 'name' | 'picture_url'>)> })> });

export type UserJoinedSubscriptionVariables = {};


export type UserJoinedSubscription = ({ __typename?: 'Subscription' } & { userConnected: Maybe<({ __typename?: 'User' } & Pick<User, 'id' | 'name' | 'picture_url'>)> });
...
export const UserJoinedDocument = gql`
  ...
  export class UserJoinedGQL extends Apollo.Subscription<UserJoinedSubscription, UserJoinedSubscriptionVariables> {
